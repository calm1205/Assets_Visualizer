...
export class Inisial1652230788173 implements MigrationInterface {
    name = 'Inisial1652230788173'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "payments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "title" character varying(40) NOT NULL, "price" integer NOT NULL, "paymentDate" TIMESTAMP NOT NULL DEFAULT '"2022-05-11T00:59:48.678Z"', "paymentType" "public"."payments_paymenttype_enum" NOT NULL, "satisfaction" smallint, "created_at" TIMESTAMP(0) NOT NULL DEFAULT now(), "updated_at" TIMESTAMP(0) NOT NULL DEFAULT now(), CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`);
