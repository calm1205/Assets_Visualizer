...
export class Inisial1651577047831 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "fix_costs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "name" character varying NOT NULL, "price" integer NOT NULL, "paymentCycle" character varying NOT NULL, "paymentType" character varying NOT NULL, "annualInterest" double precision NOT NULL DEFAULT '0', "created_at" TIMESTAMP(0) NOT NULL DEFAULT now(), "updated_at" TIMESTAMP(0) NOT NULL DEFAULT now(), CONSTRAINT "PK_4b9b2af43cba70ea9080bf1fae7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "fix_costs" ADD CONSTRAINT "FK_d91c21ba99ec35c5afc367b9ef6" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "fix_costs" DROP CONSTRAINT "FK_d91c21ba99ec35c5afc367b9ef6"`);
